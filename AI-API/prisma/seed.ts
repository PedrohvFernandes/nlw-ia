// Aqui voce pode colocar todos prompts que voce quiser, e depois rodar o comando npx prisma db seed para que ele execute todos os prompts que voce colocou aqui no banco de dados
